...
- (void)Use_test {
    ...
    UIView *view1;
    [self zm_flipView:view1 Rect:CGRectMake(0, 0, SSWIDTH, SSHEIGHT) forView:self timeInterval:0.1];

    
    
    UILabel *_myLab1;
    // 设置各个圆角
    [self zm_setCornersOfView:_myLab1 byCorners:UIRectCornerTopLeft|UIRectCornerBottomLeft
    ...
    // 设置阴影
    [self zm_setshadowOfView:_myLab1
    ...
    [self zm_drawDashLineOfDashArray:dashArray3
...
/**
 ...
 @param lineColor 线颜色
 */
- (void)zm_drawDashLineOfDashArray:(const CGFloat * __nullable)dashArray
