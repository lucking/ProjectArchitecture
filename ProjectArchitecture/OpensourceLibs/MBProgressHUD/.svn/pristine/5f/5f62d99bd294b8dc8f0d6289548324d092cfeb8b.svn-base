...
- (void)layoutSubviews {
    ...
    if (nil != self.labelText) {
        ...
        CGSize dims=[self.labelText sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:17.0f]}];
        ...
        if (nil != self.detailsLabelText) {
            ...
            NSDictionary *attributeDic = @{NSFontAttributeName:detailsLabel.font, NSParagraphStyleAttributeName: paragraph};
            
            CGSize labelSize =[detailsLabel.text boundingRectWithSize:CGSizeMake(frame.size.width - 4*margin, maxHeight) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attributeDic context:nil].size;
